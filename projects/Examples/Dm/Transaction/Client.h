...
#ifndef OPTION_EXAMPLES_DM_TRANSACTION_CLIENT_REQUEST_INTERVAL_MS
#define OPTION_EXAMPLES_DM_TRANSACTION_CLIENT_REQUEST_INTERVAL_MS 1000  // 1sec
#endif

/// Difference between the upper and lower limits
#ifndef OPTION_EXAMPLES_DM_TRANSACTION_CLIENT_LIMIT_RANGE
#define OPTION_EXAMPLES_DM_TRANSACTION_CLIENT_LIMIT_RANGE 10
#endif

/// Delta change - between transactions - for the Client's request limits (upper and lower)
#ifndef OPTION_EXAMPLES_DM_TRANSACTION_CLIENT_TRANSACTION_DELTA
#define OPTION_EXAMPLES_DM_TRANSACTION_CLIENT_TRANSACTION_DELTA 100
#endif

/// Number of interations to run the Client/Server transaction before terminating the application
#ifndef OPTION_EXAMPLES_DM_TRANSACTION_CLIENT_NUM_ITERATIONS
#define OPTION_EXAMPLES_DM_TRANSACTION_CLIENT_NUM_ITERATIONS 100
#endif
...
protected:
    ...
    void expired() noexcept override
    {
        ...
        if ( m_iterationCount >= OPTION_EXAMPLES_DM_TRANSACTION_CLIENT_NUM_ITERATIONS )
        {
        ...
        int32_t  upperLimit = m_offset + OPTION_EXAMPLES_DM_TRANSACTION_CLIENT_LIMIT_RANGE;
    ...
    void triggerChanged( MpFoo& mpThatChanged, Kit::Dm::IObserver& observer ) noexcept
    {
        ...
        if ( mpThatChanged.readAndSync( data, observer ) )
        {
            ...
            m_offset += OPTION_EXAMPLES_DM_TRANSACTION_CLIENT_TRANSACTION_DELTA;
            Timer::start( OPTION_EXAMPLES_DM_TRANSACTION_CLIENT_REQUEST_INTERVAL_MS );
        }
    }

...
#include "Examples/Container/RingBuffer/FlashCode.h"
...
{
    Examples::Container::RingBuffer::exitCode_ = Kit::System::Shutdown::eSUCCESS;
    Examples::Container::RingBuffer::waitForShutdown_.signal();
    return Examples::Container::RingBuffer::exitCode_;
}

int Kit::System::Shutdown::failure( int exitCode ) noexcept
{
    Examples::Container::RingBuffer::exitCode_ = exitCode;
    Examples::Container::RingBuffer::waitForShutdown_.signal();
    return Examples::Container::RingBuffer::exitCode_;
}
//------------------------------------------------------------------------------
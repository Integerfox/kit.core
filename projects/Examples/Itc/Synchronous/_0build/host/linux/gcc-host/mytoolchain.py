...
FINAL_OUTPUT_NAME = 'example.out'

# Root directory for the examples
example_root = os.path.join( NQBP_PKG_ROOT(), 'projects')
...
base_posix64.cflags    = '-m64 -std=c++11 -Wall -Werror -x c++  -fprofile-update=atomic'
base_posix64.inc       = f'-I {example_root}'
...
base_posix32.cflags    = '-m32 -std=c++11 -Wall -Werror -x c++ -fprofile-update=atomic'
base_posix32.inc       = f'-I {example_root}'

#ifndef EXAMPLES_ITC_ASYNCHRONOUS_CLIENT_H_
#define EXAMPLES_ITC_ASYNCHRONOUS_CLIENT_H_
/*------------------------------------------------------------------------------
...
#include "Examples/Itc/Asynchronous/IRateResponse.h"
...
protected:
    ...
    Examples::Itc::Synchronous::IRateRequest::SAP& m_serverSAP;

    /// Rate Msg: Payload
    Examples::Itc::Synchronous::IRateRequest::RatePayload_T m_ratePayload;

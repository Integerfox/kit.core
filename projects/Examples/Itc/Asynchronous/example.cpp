...
#include "example.h"
#include "Client.h"
#include "Examples/Itc/Synchronous/Server.h"
...
static uint32_t flashRatesMs[] = { OPTION_EXAMPLES_ITC_SYNCHRONOUS_SERVER_MIN_FLASH_RATE_MS,
                                   OPTION_EXAMPLES_ITC_SYNCHRONOUS_SERVER_MIN_FLASH_RATE_MS * 2,
                                   OPTION_EXAMPLES_ITC_SYNCHRONOUS_SERVER_MIN_FLASH_RATE_MS * 4,
...
{
    Examples::Itc::Asynchronous::exitCode_ = Kit::System::Shutdown::eSUCCESS;
    return Examples::Itc::Asynchronous::exitCode_;
}

int Kit::System::Shutdown::failure( int exitCode ) noexcept
{
    Examples::Itc::Asynchronous::exitCode_ = exitCode;
    return Examples::Itc::Asynchronous::exitCode_;
}

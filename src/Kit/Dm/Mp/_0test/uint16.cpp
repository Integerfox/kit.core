...
static Mp::Uint16 mp_apple_( modelDb_, "APPLE" );
static Mp::Uint16 mp_orange_( modelDb_, "ORANGE", INITIAL_VALUE );
...
TEST_CASE( "Uint16" )
{
    ...
    SECTION( "gets" )
    {
        ...
        REQUIRE( strcmp( mpType, "Kit::Dm::Mp::Uint16" ) == 0 );
    }
    ...
    SECTION( "toJSON-pretty" )
    {
        ...
        REQUIRE( doc["val"]["dec"] == 32512 );
        REQUIRE( STRCMP( doc["val"]["hex"], "0x7F00" ) );
    }

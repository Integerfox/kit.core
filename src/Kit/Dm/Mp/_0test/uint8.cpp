...
static Mp::Uint8 mp_apple_( modelDb_, "APPLE" );
static Mp::Uint8 mp_orange_( modelDb_, "ORANGE", INITIAL_VALUE );
...
TEST_CASE( "Uint8" )
{
    ...
    SECTION( "gets" )
    {
        ...
        REQUIRE( strcmp( mpType, "Kit::Dm::Mp::Uint8" ) == 0 );
    }
    ...
    SECTION( "toJSON-pretty" )
    {
        ...
        REQUIRE( doc["val"]["dec"] == 128 );
        REQUIRE( STRCMP( doc["val"]["hex"], "0x80" ) );
    }
    ...
    SECTION( "fromJSON" )
    {
        ...
        const char* json   = "{name:\"APPLE\", val:134}";

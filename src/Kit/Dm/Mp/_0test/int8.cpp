...
static Mp::Int8 mp_apple_( modelDb_, "APPLE" );
static Mp::Int8 mp_orange_( modelDb_, "ORANGE", INITIAL_VALUE );
...
TEST_CASE( "Int8" )
{
    ...
    SECTION( "gets" )
    {
        ...
        REQUIRE( strcmp( mpType, "Kit::Dm::Mp::Int8" ) == 0 );
    }
    ...
    SECTION( "toJSON-pretty" )
    {
        ...
        REQUIRE( STRCMP( doc["val"]["hex"], "0x81" ) );
    }
    ...
    SECTION( "fromJSON" )
    {
        ...
        const char* json   = "{name:\"APPLE\", val:123}";

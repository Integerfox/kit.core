...
static Mp::Int16 mp_apple_( modelDb_, "APPLE" );
static Mp::Int16 mp_orange_( modelDb_, "ORANGE", INITIAL_VALUE );
...
TEST_CASE( "Int16" )
{
    ...
    SECTION( "gets" )
    {
        ...
        REQUIRE( strcmp( mpType, "Kit::Dm::Mp::Int16" ) == 0 );
    }
    ...
    SECTION( "toJSON-pretty" )
    {
        ...
        REQUIRE( STRCMP( doc["val"]["hex"], "0xFF81" ) );
    }

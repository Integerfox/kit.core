// Autogenerated with StateSmith 0.19.0+b5719011215d41a81572ed347c02b22db5d1a48f. Last run: 2025-11-17 08:04:29 AM.
...
namespace Foo::Bar
{
    ...
    void MyFsm2::dispatchEvent(EventId eventId)
    {
        switch (this->stateId)
        {
            // STATE: MyFsm2
    ...
    void MyFsm2::exitUpToStateHandler(StateId desiredState)
    {
    ...
    void MyFsm2::ROOT_enter()
    {
        this->stateId = StateId::ROOT;
    }
    
    void MyFsm2::ROOT_ChoicePoint_j1__transition()
    {
    ...
    void MyFsm2::STATE1_enter()
    {
        this->stateId = StateId::STATE1;
    }
    
    void MyFsm2::STATE1_exit()
    {
        this->stateId = StateId::ROOT;
    }
    
    void MyFsm2::STATE1_event1()
    {
        // State1 behavior
    ...
    void MyFsm2::STATE2_exit()
    {
        this->stateId = StateId::ROOT;
    }
    
    void MyFsm2::STATE2_do()
    {
        // State2 behavior
        // uml: do / { ActionF(); }
        {
    ...
    void MyFsm2::STATE3_enter()
    {
        this->stateId = StateId::STATE3;
    }
    
    void MyFsm2::STATE3_exit()
    {
        this->stateId = StateId::ROOT;
    }
    
    void MyFsm2::STATE3_event3()
    {
        // State3 behavior
    ...
    void MyFsm2::STATE3A_exit()
    {
        this->stateId = StateId::STATE3;
    }
    
    void MyFsm2::STATE3A_event1()
    {
        // State3A behavior
    ...
    void MyFsm2::STATE3B_enter()
    {
        this->stateId = StateId::STATE3B;
    }
    
    void MyFsm2::STATE3B_exit()
    {
        // State3B behavior
        // uml: exit / { ActionE(); }
        {
    ...
    void MyFsm2::TERMINAL_enter()
    {
        this->stateId = StateId::TERMINAL;
    }
    
    void MyFsm2::TERMINAL_exit()
    {
        this->stateId = StateId::ROOT;
    }
    
    // Thread safe.
    char const * MyFsm2::stateIdToString(StateId id)
    {
        switch (id)
        {
    ...
    // Thread safe.
    char const * MyFsm2::eventIdToString(EventId id)
    {
        switch (id)
        {

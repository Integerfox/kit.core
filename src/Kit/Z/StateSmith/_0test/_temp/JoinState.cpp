...
void JoinState::dispatchEvent(EventId eventId)
{
    switch (this->stateId)
    {
        // STATE: JoinState
...
void JoinState::exitUpToStateHandler(StateId desiredState)
{
    while (this->stateId != desiredState)
    {
        switch (this->stateId)
        {
            case StateId::J1: J1_exit(); break;
...
void JoinState::J1_enter()
{
    this->stateId = StateId::J1;
}

void JoinState::J1_exit()
{
    this->stateId = StateId::ROOT;
}

void JoinState::J1_do()
{
    // j1 behavior
    // uml: do / { ActionG(); } TransitionTo(State3)
    {
...
void JoinState::STATE1_enter()
{
    this->stateId = StateId::STATE1;
}

void JoinState::STATE1_exit()
{
    this->stateId = StateId::ROOT;
}

void JoinState::STATE1_event1()
{
    // State1 behavior
    // uml: Event1 TransitionTo(ROOT.<ChoicePoint>(c1))
    {
        ...
        // ROOT.<ChoicePoint>(c1) behavior
        // uml: else / { ActionC(); } TransitionTo(j1)
        {
            // Step 1: Exit states until we reach `ROOT` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            ...
            // Step 3: Enter/move towards transition target `j1`.
            J1_enter();
...
void JoinState::STATE2_exit()
{
    this->stateId = StateId::ROOT;
}

void JoinState::STATE2_do()
{
    // State2 behavior
    // uml: do / { ActionF(); }
    {
...
void JoinState::STATE2_event2()
{
    // State2 behavior
    // uml: Event2 TransitionTo(j1)
    {
        // Step 1: Exit states until we reach `ROOT` state (Least Common Ancestor for transition).
        STATE2_exit();
...
void JoinState::STATE3_enter()
{
    this->stateId = StateId::STATE3;
}

void JoinState::STATE3_exit()
{
    this->stateId = StateId::ROOT;
}

void JoinState::STATE3_event3()
{
    // State3 behavior
...
void JoinState::STATE3A_exit()
{
    this->stateId = StateId::STATE3;
}

void JoinState::STATE3A_event1()
{
    // State3A behavior
...
void JoinState::STATE3B_enter()
{
    this->stateId = StateId::STATE3B;
}

void JoinState::STATE3B_exit()
{
    // State3B behavior
    // uml: exit / { ActionE(); }
    {
...
void JoinState::TERMINAL_enter()
{
    this->stateId = StateId::TERMINAL;
}

void JoinState::TERMINAL_exit()
{
    this->stateId = StateId::ROOT;
}

// Thread safe.
char const * JoinState::stateIdToString(StateId id)
{
    switch (id)
    {
        case StateId::ROOT: return "ROOT";
        case StateId::J1: return "J1";
...
// Thread safe.
char const * JoinState::eventIdToString(EventId id)
{
    switch (id)
    {

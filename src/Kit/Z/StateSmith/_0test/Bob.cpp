...
namespace Bar {
    ...
    void Bob::fsmDispatchEvent(EventId eventId)
    {
        switch (this->stateId)
        {
            // STATE: Bob
    ...
    void Bob::exitUpToStateHandler(StateId desiredState)
    {
    ...
    void Bob::ROOT_ChoicePoint_j1__transition()
    {
    ...
    void Bob::STATE1_enter()
    {
        this->stateId = StateId::STATE1;
    }
    
    void Bob::STATE1_exit()
    {
        this->stateId = StateId::ROOT;
    }
    
    void Bob::STATE1_event1()
    {
        // State1 behavior
    ...
    void Bob::STATE3_enter()
    {
        this->stateId = StateId::STATE3;
    }
    
    void Bob::STATE3_exit()
    {
        this->stateId = StateId::ROOT;
    }
    
    void Bob::STATE3_event3()
    {
        // State3 behavior
    ...
    void Bob::STATE3A_exit()
    {
        this->stateId = StateId::STATE3;
    }
    
    void Bob::STATE3A_event1()
    {
        // State3A behavior
    ...
    void Bob::STATE3B_enter()
    {
        this->stateId = StateId::STATE3B;
    }
    
    void Bob::STATE3B_exit()
    {
        // State3B behavior
        // uml: exit / { ActionE(); }
        {
    ...
    void Bob::TERMINAL_enter()
    {
        this->stateId = StateId::TERMINAL;
    }
    
    void Bob::TERMINAL_exit()
    {
        this->stateId = StateId::ROOT;
    }
    
    // Thread safe.
    char const * Bob::stateIdToString(StateId id)
    {
        switch (id)
        {
    ...
    // Thread safe.
    char const * Bob::eventIdToString(EventId id)
    {
        switch (id)
        {
    ...
    void Bob::dispatchEvent( EventId msg )
    {
        ...
        {
            Kit::System::FatalError::logf( Kit::System::Shutdown::eFSM_EVENT_OVERFLOW, "%s(Bob): - Buffer Overflow!", tsection );
        }

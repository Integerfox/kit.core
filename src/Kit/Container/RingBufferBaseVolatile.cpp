...
#include "RingBufferBaseVolatile.h"
...
RingBufferBaseVolatile::RingBufferBaseVolatile( unsigned numMaxElements ) noexcept
    : m_readIdx( 0 )
    , m_writeIdx( 0 )
...
bool RingBufferBaseVolatile::remove( void* elemPtr, size_t elemSize, const void* srcRingBufMemory ) noexcept
{
...
bool RingBufferBaseVolatile::add( const void* elemPtr, size_t elemSize, void* dstRingBufMemory ) noexcept
{
    KIT_SYSTEM_ASSERT( elemPtr != nullptr );
    KIT_SYSTEM_ASSERT( elemSize > 0 );
...
bool RingBufferBaseVolatile::peekHead( void* elemPtr, size_t elemSize, const void* srcRingBufMemory ) noexcept
{
    KIT_SYSTEM_ASSERT( elemPtr != nullptr );
    KIT_SYSTEM_ASSERT( elemSize > 0 );
    KIT_SYSTEM_ASSERT( srcRingBufMemory != nullptr );
...
bool RingBufferBaseVolatile::peekTail( void* elemPtr, size_t elemSize, const void* srcRingBufMemory ) noexcept
{
    KIT_SYSTEM_ASSERT( elemPtr != nullptr );
    KIT_SYSTEM_ASSERT( elemSize > 0 );
    KIT_SYSTEM_ASSERT( srcRingBufMemory != nullptr );
...
void* RingBufferBaseVolatile::peekNextRemoveItems( unsigned& dstNumFlatElements, size_t elemSize, const void* srcRingBufMemory ) const noexcept
{
    KIT_SYSTEM_ASSERT( srcRingBufMemory != nullptr );
...
void* RingBufferBaseVolatile::peekNextAddItems( unsigned& dstNumFlatElements, size_t elemSize, const void* srcRingBufMemory ) const noexcept
{
    // Snapshot of ring buffer's indexes
    unsigned readIdx  = m_readIdx;
    unsigned writeIdx = m_writeIdx;

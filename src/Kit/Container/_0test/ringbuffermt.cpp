...
#include "Kit/Container/RingBufferMTAllocate.h"
...
namespace {
class MyRingBuffer : public RingBufferMTAllocate<uint64_t, NUM_ELEMENTS + 1>
{
public:
    // Constructor
    MyRingBuffer()
        : RingBufferMTAllocate<uint64_t, NUM_ELEMENTS + 1>()
    {
    }
...
TEST_CASE( "RingBufferMT" )
{
    ...
    {
        RingBufferMTAllocate<int8_t, NUM_ELEMENTS + 1> uut;

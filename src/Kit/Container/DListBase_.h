...
protected:
    ...
    ExtendedItem* getFirst( void ) noexcept
    {
    ...
    ExtendedItem* getLast( void ) noexcept
    {
...
protected:
     ...
     */
    ExtendedItem* first( void ) const noexcept
    {
        return m_headPtr;
    }
    ...
    /** Return a pointer to the last item in the list.
        ...
        if the list is empty.
     */
    ExtendedItem* last( void ) const noexcept
    {
        return m_tailPtr;
    }

protected:
    /** Remove the specified 'item' element from the list.

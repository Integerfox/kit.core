...
Cpl::System::Api::sleep( 100 ); // Give the compiler a chance to optimize the code
Kit::System::Api::sleep( 100 ); // Give the compiler a chance to optimize the code
Kcl::System::Api::sleep( 100 ); // Give the compiler a chance to optimize the code
Kcl::Driver::I2C::Master driver(...);
Kit::Driver::I2C::Master driver(...);
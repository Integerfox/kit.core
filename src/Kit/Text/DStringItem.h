...
public:
    /// Constructor
    DStringItem( const IString& string, int initialSize = 0, int blocksize = OPTION_KIT_TEXT_DSTRING_ALLOC_BLOCK_SIZE )
        : StringItem( m_internalString ), m_internalString( string, initialSize, blocksize ) {}

    /// Constructor
    DStringItem( const char* string = "", int initialSize = 0, int blocksize = OPTION_KIT_TEXT_DSTRING_ALLOC_BLOCK_SIZE )
        : StringItem( m_internalString ), m_internalString( string, initialSize, blocksize ) {}

...
import os
FINAL_OUTPUT_NAME = 'hw_supervisor'
...
base_release.cppflags = f' -std=c++11 -Wno-int-in-bool-context -DENABLE_BSP_SEGGER_SYSVIEW -I{sysview_root}'
...
release_opts = { 'user_base':base_release, 'user_optimized':optimized_release, 'user_debug':debug_release }

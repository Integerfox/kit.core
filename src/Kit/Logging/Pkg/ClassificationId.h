...
#define KIT_LOGGING_PKG_CLASSIFICATION_ID_FATAL KIT_LOGGING_PKG_CLASSIFICATION_ID_FATAL_MAPCFG

/// Defer the actual values to the Application (via the kit_config.h file).
#define KIT_LOGGING_PKG_CLASSIFICATION_ID_WARNING KIT_LOGGING_PKG_CLASSIFICATION_ID_WARNING_MAPCFG

/// Defer the actual values to the Application (via the kit_config.h file).
#define KIT_LOGGING_PKG_CLASSIFICATION_ID_EVENT KIT_LOGGING_PKG_CLASSIFICATION_ID_EVENT_MAPCFG

/// Defer the actual values to the Application (via the kit_config.h file).
#define KIT_LOGGING_PKG_CLASSIFICATION_ID_INFO KIT_LOGGING_PKG_CLASSIFICATION_ID_INFO_MAPCFG
...
BETTER_ENUM( ClassificationId, uint8_t,
             FATAL   = KIT_LOGGING_PKG_CLASSIFICATION_ID_FATAL,
             WARNING = KIT_LOGGING_PKG_CLASSIFICATION_ID_WARNING,
             EVENT   = KIT_LOGGING_PKG_CLASSIFICATION_ID_EVENT,
             INFO    = KIT_LOGGING_PKG_CLASSIFICATION_ID_INFO
);
// clang-format off

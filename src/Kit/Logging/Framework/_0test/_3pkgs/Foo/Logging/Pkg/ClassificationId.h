#ifndef FOO_LOGGING_PKG_CLASSIFICATIONID_H_
#define FOO_LOGGING_PKG_CLASSIFICATIONID_H_
/*-----------------------------------------------------------------------------
...
#define FOO_LOGGING_PKG_CLASSIFICATION_ID_EVENT   FOO_LOGGING_PKG_CLASSIFICATION_ID_EVENT_MAPCFG
#define FOO_LOGGING_PKG_CLASSIFICATION_ID_WARNING FOO_LOGGING_PKG_CLASSIFICATION_ID_WARNING_MAPCFG
#define FOO_LOGGING_PKG_CLASSIFICATION_ID_DEBUG   FOO_LOGGING_PKG_CLASSIFICATION_ID_DEBUG_MAPCFG
...
BETTER_ENUM( ClassificationId, uint8_t,
             WARNING = FOO_LOGGING_PKG_CLASSIFICATION_ID_WARNING,
             EVENT   = FOO_LOGGING_PKG_CLASSIFICATION_ID_EVENT,
             DEBUG   = FOO_LOGGING_PKG_CLASSIFICATION_ID_DEBUG
);
// clang-format off
